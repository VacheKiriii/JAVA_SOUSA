...
public class TestJDBC {
    public static void main(String[] args) {
        ...
        String pwdLocal = "";
        String urlDistant = "jdbc:mariadb://XXX"; // Remplace XXX par l'adresse réelle de la BDD distante
        String userDistant = "XXX";               // Remplace XXX par l'utilisateur de la BDD distante
        String pwdDistant = "XXX";                // Remplace XXX par le mot de passe de la BDD distante
